                                            ...
                                            <tr>
                                                ...
                                                <td class="w-50">
                                                    <div class="invoice-middle-right">
                                                        <h4>Invoice From:</h4>
                                                        <p class="mb_0">{{ env('APP_NAME') ?? 'Tripsummit' }}</p>
                                                        <p class="mb_0">{{ $admin_data->name }}</p>
                                                        <p class="mb_0 color_6d6d6d">{{ $admin_data->email }}</p>
                                                        <p class="mb_0 color_6d6d6d">Payment Status: {{ $booking->payment_status }}</p>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
                                    ...
                                    <table class="table table-bordered invoice-item-table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>Rp. {{ $booking->package->price }}</td>
                                                <td>{{ $booking->total_person }}</td>
                                                <td>Rp. {{ $booking->paid_amount }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
