                        ...
                        <form action="{{ route('packages') }}" method="get">
                            ...
                            <div class="widget">
                                ...
                                <div class="box">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="text" name="min_price" value="{{ $form_min_price }}" class="form-control" placeholder="Min">
                                        </div>
                                        <div class="col-md-6">
                                            <input type="text" name="max_price" value="{{ $form_max_price }}" class="form-control" placeholder="Max">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="widget">
                                ...
                                <div class="box">
                                    ...
                                    <div class="form-check form-check-review">
                                        <input name="review" class="form-check-input" type="radio" name="reviewRadios"
                                            id="reviewRadios2" value="4.5" @if($form_review == '4.5') checked @endif>
                                    ...
                                    <div class="form-check form-check-review">
                                        <input name="review" class="form-check-input" type="radio" name="reviewRadios"
                                            id="reviewRadios3" value="4" @if($form_review == '4') checked @endif>
                                    ...
                                    <div class="form-check form-check-review">
                                        <input name="review" class="form-check-input" type="radio" name="reviewRadios"
                                            id="reviewRadios4" value="3.5" @if($form_review == '3.5') checked @endif>
                                    ...
                                    <div class="form-check form-check-review">
                                        <input name="review" class="form-check-input" type="radio" name="reviewRadios"
                                            id="reviewRadios5" value="3" @if($form_review == '3') checked @endif>
                                    ...
                                    <div class="form-check form-check-review">
                                        <input name="review" class="form-check-input" type="radio" name="reviewRadios"
                                            id="reviewRadios6" value="2.5" @if($form_review == '2.5') checked @endif>
                                    ...
                                    <div class="form-check form-check-review">
                                        <input name="review" class="form-check-input" type="radio" name="reviewRadios"
                                            id="reviewRadios7" value="2" @if($form_review == '2') checked @endif>
                                    ...
                                    <div class="form-check form-check-review">
                                        <input name="review" class="form-check-input" type="radio" name="reviewRadios"
                                            id="reviewRadios8" value="1.5" @if($form_review == '1.5') checked @endif>
                                    ...
                                    <div class="form-check form-check-review">
                                        <input name="review" class="form-check-input" type="radio"
                                            name="reviewRadios" id="reviewRadios9" value="1" @if($form_review == '1') checked @endif>
