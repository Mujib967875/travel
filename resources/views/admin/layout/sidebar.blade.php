<div class="main-sidebar">
            <aside id="sidebar-wrapper">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="{{ Request::is('admin/package/*')||Request::is('admin/package-itineraries/*')||Request::is('admin/package-itinerary/*')||Request::is('admin/package-amenities/*')||Request::is('admin/package-amenity/*')||Request::is('admin/package-photos/*')||Request::is('admin/package-photo/*')||Request::is('admin/package-videos/*')||Request::is('admin/package-video/*')? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_package_index')}}"><i class="fas fa-hand-point-right"></i> <span> Package</span></a></li>
